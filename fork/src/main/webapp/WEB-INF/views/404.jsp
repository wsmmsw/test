...
<head>
    ...
    <link href="/fork/assets/css/pages/error.css" rel="stylesheet" type="text/css"/>
...
<div class="row">
    <div class="col-md-12 page-404">
        ...
        <div class="details">
            ...
            <p>
                We can not find the page you're looking for.<br/> <a href="<%=basePath%>">Return home</a> or try the
                search bar below.
            </p>
            <form action="#">
...
<!-- END CORE PLUGINS -->
<script src="/fork/assets/scripts/app.js"></script>
<script>
